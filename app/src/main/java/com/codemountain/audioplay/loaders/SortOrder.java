...
public final class SortOrder {
    ...
    public interface PlaylistSongSortOrder {
        /* Playlist song sort order A-Z */
        String SONG_A_Z = MediaStore.Audio.Playlists.Members.DEFAULT_SORT_ORDER;

        /* Playlist song sort order Z-A */
        String SONG_Z_A = SONG_A_Z + " DESC";

        /* Playlist song sort order album */
        String SONG_ALBUM = MediaStore.Audio.Playlists.Members.ALBUM;

        /* Playlist song sort order year */
        String SONG_YEAR = MediaStore.Audio.Playlists.Members.YEAR + " DESC";

        /* Playlist song sort order duration */
        String SONG_DURATION = MediaStore.Audio.Playlists.Members.DURATION + " DESC";

        /* Playlist song sort order date */
        String SONG_DATE = MediaStore.Audio.Playlists.Members.DATE_ADDED + " DESC";
    }
