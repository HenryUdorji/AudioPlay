...
public class ArtistDetailsAdapter extends RecyclerView.Adapter<ArtistDetailsAdapter.AlbumsViewHolder> {
    ...
    public ArtistDetailsAdapter(Context context, List<Song> songList) {
    ...
    private void openBottomSheetDialog(int position, View view) {
        ...
        addToPlaylist.setOnClickListener(v -> {
            ...
            FragmentManager manager = ((ArtistDetailActivity)context).getSupportFragmentManager();
        ...
        delete.setOnClickListener(v -> {
            ...
            String path = song.getmSongPath();
            Helper.deleteTrack(name, path, context);
            if (path == null){
        ...
        addToQueue.setOnClickListener(v -> {
            ((ArtistDetailActivity) context).addToQueue(song);
            Toast.makeText(context, R.string.song_added_to_queue, Toast.LENGTH_SHORT).show();
            bottomSheetDialog.dismiss();
        });
        playNext.setOnClickListener(v -> {
            ((ArtistDetailActivity)context).setAsNextTrack(song);
