...
public class AlbumDetailsAdapter extends RecyclerView.Adapter<AlbumDetailsAdapter.AlbumsViewHolder> {
    ...
    public AlbumDetailsAdapter(Context context, List<Song> songList) {
    ...
    private void openBottomSheetDialog(int position, View view) {
        ...
        addToPlaylist.setOnClickListener(v -> {
            ...
            FragmentManager manager = ((AlbumsDetailActivity)context).getSupportFragmentManager();
        ...
        addToQueue.setOnClickListener(v -> {
            ((AlbumsDetailActivity) context).addToQueue(song);
            Toast.makeText(context, R.string.song_added_to_queue, Toast.LENGTH_SHORT).show();
            bottomSheetDialog.dismiss();
        });
        playNext.setOnClickListener(v -> {
            ((AlbumsDetailActivity)context).setAsNextTrack(song);
