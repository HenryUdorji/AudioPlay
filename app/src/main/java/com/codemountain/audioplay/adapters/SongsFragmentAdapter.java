...
public class SongsFragmentAdapter extends RecyclerView.Adapter<SongsFragmentAdapter.SongsViewHolder> {
    ...
    public SongsFragmentAdapter(Context context, List<Song> songsList) {
    ...
    public Song getItem(int position) {
        if (songsList == null || songsList.size() < 0 || songsList.size() == 0) {
            return null;
        }
